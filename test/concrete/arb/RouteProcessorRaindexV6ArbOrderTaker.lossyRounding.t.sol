...
import {Float} from "raindex-interface-0.1.7/src/interface/IRaindexV6.sol";
...
contract RouteProcessorRaindexV6ArbOrderTakerLossyRoundingTest is Test {
    ...
    function testOnTakeOrders2LossyOutputRoundsUp() external {
        ...
        iOutputToken.mint(LibRaindexDeploy.ROUTE_PROCESSOR_DEPLOYED_ADDRESS, 1);
