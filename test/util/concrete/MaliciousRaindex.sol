...
/// @dev Malicious raindex that records the token allowances it has from the
/// borrower during flashLoan, before calling onFlashLoan (which will revert
/// with BadLender since this contract is not the deterministic raindex).
contract MaliciousRaindex is MockRaindexBase {
