...
- `raindex_app_settings`: typed config model + YAML parsing helpers for order builder sections, deployments, networks, orders, select-tokens, and validation rules.
