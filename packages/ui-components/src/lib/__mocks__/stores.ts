...
export const mockShowInactiveOrdersStore = {
  ...
  mockSetSubscribeValue: (value: boolean): void =>
    mockShowInactiveOrdersWritable.set(value),
};
...
export const mockOrderHashStore = {
  ...
  mockSetSubscribeValue: (value: string): void =>
    mockOrderHashWritable.set(value),
};
...
export const mockHideZeroBalanceVaultsStore = {
  ...
  mockSetSubscribeValue: (value: boolean): void =>
    mockHideZeroBalanceVaultsWritable.set(value),
};
...
export const mockHideInactiveOrdersVaultsStore = {
  ...
  mockSetSubscribeValue: (value: boolean): void =>
    mockHideInactiveOrdersVaultsWritable.set(value),
};
...
export const mockActiveNetworkRefStore = {
  ...
  mockSetSubscribeValue: (value: string): void =>
    mockActiveNetworkRefWritable.set(value),
};
...
export const mockActiveRaindexRefStore = {
  ...
  mockSetSubscribeValue: (value: string): void =>
    mockActiveRaindexRefWritable.set(value),
};
...
export const mockSubgraphUrlStore = {
  ...
  mockSetSubscribeValue: (value: string): void =>
    mockSubgraphUrlWritable.set(value),
};
...
export const mockSelectedChainIdsStore = {
  ...
  mockSetSubscribeValue: (value: number[]): void =>
    mockSelectedChainIdsWritable.set(value),
};
...
export const mockActiveTokensStore = {
  ...
  mockSetSubscribeValue: (value: string[]): void =>
    mockActiveTokensWritable.set(value),
};
...
export const mockActiveRaindexAddressesStore = {
  ...
  mockSetSubscribeValue: (value: string[]): void =>
    mockActiveRaindexAddressesWritable.set(value),
};
...
export const mockOwnerFilterStore = {
  ...
  mockSetSubscribeValue: (value: Address): void =>
    mockOwnerFilterWritable.set(value),
};
