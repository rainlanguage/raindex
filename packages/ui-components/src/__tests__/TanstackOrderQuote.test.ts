...
describe("TanstackOrderQuote component", () => {
  ...
  it("refreshes the quote when the refresh icon is clicked", async () => {
    ...
    (invalidateTanstackQueries as Mock).mockImplementation(
  ...
  it("triggers a toast when the quote fails to refresh", async () => {
    (invalidateTanstackQueries as Mock).mockRejectedValueOnce(
      ...
      value: [
        {
          ...
          pair: { pairName: "ETH/USDT", inputIndex: 0, outputIndex: 1 },
          data: {
            maxOutput: "0x158323e942e36d8c",
            ratio: "0x5b16799fcb6114f7",
          },
          error: undefined,
        },
        {
          ...
          pair: { pairName: "BTC/USDT", inputIndex: 0, outputIndex: 1 },
          data: {
            maxOutput: "0x54fa82f5c7001dad",
            ratio: "0x53e0089714d06709",
          },
          error: undefined,
        },
      ],
