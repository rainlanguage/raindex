...
- Purpose
  - Provide a cohesive, app‑ready set of Svelte components and helpers for Raindex features: tables, detail views, charts, deployment builder, toasts, and transaction UX.
