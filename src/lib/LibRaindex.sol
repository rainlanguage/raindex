...
import {LibNamespace, FullyQualifiedNamespace} from "rainlang-interface-0.2.9/src/lib/ns/LibNamespace.sol";
...
/// `uint256` so it must be added to input balances and subtracted from output
/// balances.
