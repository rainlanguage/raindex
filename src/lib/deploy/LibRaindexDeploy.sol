...
library LibRaindexDeploy {
    ...
    uint256 constant RAINDEX_START_BLOCK_BASE = 46821101;
    uint256 constant RAINDEX_START_BLOCK_FLARE = 62120949;
    uint256 constant RAINDEX_START_BLOCK_POLYGON = 87823904;
}
