...
import {
    DEPLOYED_ADDRESS as GenericPoolRaindexV6FlashBorrower_0_1_15_DEPLOYED_ADDRESS,
    BYTECODE_HASH as GenericPoolRaindexV6FlashBorrower_0_1_15_BYTECODE_HASH,
    CREATION_CODE as GenericPoolRaindexV6FlashBorrower_0_1_15_CREATION_CODE,
    RUNTIME_CODE as GenericPoolRaindexV6FlashBorrower_0_1_15_RUNTIME_CODE,
    DEPENDENCIES as GenericPoolRaindexV6FlashBorrower_0_1_15_DEPENDENCIES
} from "../generated/0_1_15/GenericPoolRaindexV6FlashBorrower.sol";
...
library LibGenericPoolRaindexV6FlashBorrowerReleased {
    ...
    function releasedSuites() internal pure returns (DeploySuite[] memory) {
        ...
        suites[1] = DeploySuite({
            suite: "arb-generic-pool-flash-borrower@0_1_15",
            creationCode: GenericPoolRaindexV6FlashBorrower_0_1_15_CREATION_CODE,
            storedDeployedAddress: GenericPoolRaindexV6FlashBorrower_0_1_15_DEPLOYED_ADDRESS,
            storedBytecodeHash: GenericPoolRaindexV6FlashBorrower_0_1_15_BYTECODE_HASH,
            storedRuntimeCode: GenericPoolRaindexV6FlashBorrower_0_1_15_RUNTIME_CODE,
            artifactPath: "src/concrete/arb/GenericPoolRaindexV6FlashBorrower.sol:GenericPoolRaindexV6FlashBorrower",
            dependencies: abi.decode(GenericPoolRaindexV6FlashBorrower_0_1_15_DEPENDENCIES, (address[]))
        });
        return suites;
    }
}
